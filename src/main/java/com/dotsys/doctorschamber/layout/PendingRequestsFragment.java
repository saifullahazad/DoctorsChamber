 ...
 */
public class PendingRequestsFragment extends android.app.Fragment {

    View myView, request_view, mProgressView;
    android.app.Fragment pendingRequestsFragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        title.setText(getString(R.string.title_fragment_pending_requests));
    ...
    public class TreatmentRequestTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                List<TreatmentRequest> myPendingRequests = Global.myPendingRequest;
                for (TreatmentRequest request : myPendingRequests) {
                    // do something with object
                    RequestTableRow requestTableRow = new RequestTableRow(pendingRequestsFragment.getContext(),pendingRequestsFragment,request);
